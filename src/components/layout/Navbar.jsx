...
const navSectionIds = ['home', 'about', 'academic', 'portfolio', 'contact'];
        ...
        <div className={`navbar-container ${scrolled ? 'scrolled' : ''}`}>
          ...
          >
            <div className="navbar-logo-icon">
              <img src="/Images/LogoDevGreg.png" alt="Aadii Logo" className="navbar-logo-img" />
            </div>
            <span className="navbar-logo-text">
              Aa<span className="navbar-logo-highlight">dii</span>
            </span>
          </motion.a>
