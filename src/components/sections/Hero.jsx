    ...
    >
      ...
      >
        ...
        <div className="hero-code-panel-content">
          ...
          <div className="hero-code-panel-line-indent"><span style={{ color: '#93c5fd' }}>name</span><span style={{ color: 'rgba(255,255,255,0.5)' }}>:</span> <span style={{ color: '#6ee7b7', borderBottom: '1px solid rgba(110,231,183,0.3)' }}>"Mohamed Aadil"</span><span style={{ color: 'rgba(255,255,255,0.5)' }}>,</span></div>
